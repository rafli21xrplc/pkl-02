...
@section('content')
    <div class="mt-8">
        <div class="mb-3 flex justify-between">
            <h3 class="text-xl font-bold text-gray-900 mb-2">Absensi Dosen</h3>
            <button class="bg-cyan-500 shadow-cyan-500/50 text-white py-1 px-2 rounded-lg hover hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-cyan-300 shadow-md"><a href="/admin/form_dosen">Tambah Data</a></button>
        </div>
            ...
            <table class="w-full border-collapse bg-white text-left text-sm text-gray-500">
                <thead class="bg-gray-100">
                    <tr class="text-center">
                        ...
                        <th scope="col" class="px-6 py-4 font-medium text-gray-900">Jadwal</th>
                        <th scope="col" class="px-6 py-4 font-medium text-gray-900">Siswa</th>
                ...
                <tbody class="divide-y divide-gray-100 border-t border-gray-100 text-center">
                    <tr class="hover:bg-gray-50">
                        ...
                        <th class="flex gap-3 px-6 py-4 font-normal text-gray-900 text-left">
                            ...
                            <td class="px-6 py-4 text-center">Engenering</td>
                        <td class="px-6 py-4">
                            <span>27 / 8 / 2023</span>
                        </td>
                        <td class="px-6 py-4">
